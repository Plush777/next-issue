...
import customGameData from 'locales/ko/mode/singleMode/customGame/contents.json';
import { useState } from 'react';

const CustomGame = () => {
    const [customGameContents] = useState(customGameData);
    ...
    return ( 
        <>
            ...
            <Substyled.Main id='main'>
                <SubVisual/>
                <SubTab/>
                <CustomGameContents customGameContents={customGameContents}/>
                <FootSupport/>
                <FootNotice/>
                <Footer/>
            </Substyled.Main>
