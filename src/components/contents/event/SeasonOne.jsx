...
import { ReactComponent as SCarrowRight } from 'static/svg/ico-arrow-right-type02.svg';

const SeasonOne = ({ eventContents }) => {

    const { t } = useTranslation();
    const [loading, handleLoad] = useImageLoading();
    const depth1 = eventContents.evItem.evDepth1;
