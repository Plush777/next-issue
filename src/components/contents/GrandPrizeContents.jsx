...
const GrandPrizeContents = ({ grandPrizeContents }) => {
                            ...
                            <Tablestyled.Wrap gridTemplateColumns="repeat(3, 240px)" display="grid" rg="60px" jc="space-between" type="full">
                                ...
                                <Tablestyled.Group>
                                    ...
                                    <Tablestyled.Table className="type02">
                                        ...
                                        <Tablestyled.Body flex>
                                            <Tablestyled.Row>
                                                {Object.keys(grandPrizeContents.gpItem.gpDepth1.group5).map((item,index) => {
                                                    return(
                                            ...
                                            <Tablestyled.Row>
                                                {Object.keys(grandPrizeContents.gpItem.gpDepth1.group10).map((item,index) => {
                                                    return(
                                ...
                                <Tablestyled.Group>
                                    ...
                                    <Tablestyled.Table className="type02">
                                        ...
                                        <Tablestyled.Body flex>
                                            <Tablestyled.Row>
                                                {Object.keys(grandPrizeContents.gpItem.gpDepth1.group6).map((item,index) => {
                                                    return(
                                            ...
                                            <Tablestyled.Row>
                                                {Object.keys(grandPrizeContents.gpItem.gpDepth1.group11).map((item,index) => {
                                                    return(
                                                        <Tablestyled.CellDescription as="td" key={index}>
                                ...
                                <Tablestyled.Group>
                                    ...
                                    <Tablestyled.Table className="type02">
                                        ...
                                        <Tablestyled.Body flex>
                                            <Tablestyled.Row>
                                                {Object.keys(grandPrizeContents.gpItem.gpDepth1.group7).map((item,index) => {
                                                    return(
                                            ...
                                            <Tablestyled.Row>
                                                {Object.keys(grandPrizeContents.gpItem.gpDepth1.group12).map((item,index) => {
                                                    return(
                                                        <Tablestyled.CellDescription as="td" key={index}>
                                ...
                                <Tablestyled.Group>
                                    ...
                                    <Tablestyled.Table className="type02">
                                        ...
                                        <Tablestyled.Body flex>
                                            <Tablestyled.Row>
                                                {Object.keys(grandPrizeContents.gpItem.gpDepth1.group8).map((item,index) => {
                                                    return(
                                            ...
                                            <Tablestyled.Row>
                                                {Object.keys(grandPrizeContents.gpItem.gpDepth1.group13).map((item,index) => {
                                                    return(
                                                        <Tablestyled.CellDescription as="td" key={index}>
                                ...
                                <Tablestyled.Group>
                                    ...
                                    <Tablestyled.Table className="type02">
                                        ...
                                        <Tablestyled.Body flex>
                                            <Tablestyled.Row>
                                                {Object.keys(grandPrizeContents.gpItem.gpDepth1.group9).map((item,index) => {
                                                    return(
                                            ...
                                            <Tablestyled.Row>
                                                {Object.keys(grandPrizeContents.gpItem.gpDepth1.group14).map((item,index) => {
                                                    return(
                                                        <Tablestyled.CellDescription as="td" key={index}>
