...
export const Title = styled.h2`
    ...
    &::before{content: ''; position: absolute; top: -4px; left: 0; width: 36px; height: 36px;
    background-size: 36px; background-repeat: no-repeat; background-position: center;}

    &.fire::before{background-image: url('/images/common/ico-fire.png')}
    &.thinking::before{background-image: url('/images/common/ico-thinking.png')}
